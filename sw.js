const CACHE_NAME = "ostatni-kurs-v8";
const CORE_URLS = [
  "./",
  "./index.html",
  "./landing.html",
...
const ASSET_URLS = [
  ...
  "./assets/generated/roadwork-sprite-sheet-v1.png",
  "./assets/generated/traffic-sprite-sheet-v2.png",
  "./assets/generated/traffic-sprite-sheet-v3.png",
  ...
  "./assets/sprites/pedestrian-side-d.png",
  "./assets/sprites/pedestrian-side-e.png",
  "./assets/sprites/plac.png",
  "./assets/sprites/pothole.png",
  "./assets/sprites/powerline.png",
  "./assets/sprites/prop-construction-barrel.png",
  "./assets/sprites/prop-bin.png",
  "./assets/sprites/prop-bollard.png",
  "./assets/sprites/prop-ad-column.png",
  "./assets/sprites/prop-lamp.png",
  "./assets/sprites/prop-manhole-cover.png",
  "./assets/sprites/prop-news-kiosk.png",
  "./assets/sprites/prop-pole.png",
  "./assets/sprites/prop-road-barrier.png",
  "./assets/sprites/prop-road-cone.png",
  "./assets/sprites/prop-road-cones.png",
  "./assets/sprites/prop-roadwork-sign.png",
  "./assets/sprites/prop-sandbags.png",
  "./assets/sprites/prop-ticket-machine.png",
  "./assets/sprites/prop-tree.png",
  "./assets/sprites/police-side-blue.png",
  "./assets/sprites/roadworks-truck-side.png",
  "./assets/sprites/road-pothole.png",
  "./assets/sprites/scooter-side.png",
  ...
  "./assets/sprites/taxi-side-yellow.png",
...
self.addEventListener("fetch", (event) => {
  ...
  const isAppShell = url.origin === self.location.origin && /\.(?:html|css|js)$/.test(url.pathname);
  if (isAppShell) {
    event.respondWith(
      fetch(event.request)
        .then((response) => {
